...
public:
  ...
  void setup2() {
    ...
    sphere1->color() = VEC3F(.25, .25, 1);
    sphere1->isGlass();
	//sphere1->isMirror();
    _primitives.push_back(sphere1);
    
    SPHERE* sphere3 = new SPHERE(VEC3F(4.5, 0, -10), 2);
    sphere3->color() = VEC3F(1, 0.25, 0.25);
    sphere3->isMirror();
	_primitives.push_back(sphere3);
   
	//SPHERE* sphere2 = new SPHERE(VEC3F(0, -1000, -10), 997);
	//sphere2->color() = VEC3F(.5, .5, .5);
	//_primitives.push_back(sphere2);	
    ...
    LIGHT* light1 = new LIGHT(VEC3F(-10, 3, -7.5), VEC3F(0.5, 0, 0));
    _lights.push_back(light1);
  }
